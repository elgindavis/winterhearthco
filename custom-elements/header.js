    ...
    this.innerHTML = `<header id="header">
		    <div class="container main-menu">
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
			        <a href="${this.isNotRootDirectory ? this.changeLinkDirectory : ""}." aria-label="Winter Hearth Home Page Icon"><img style="max-height: 56px;" src="${this.isNotRootDirectory ? this.changeLinkDirectory : ""}img/logo-100p.jpg" alt="" title="" /></a>
			      </div>
