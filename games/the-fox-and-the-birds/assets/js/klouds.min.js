    ...
    function (e, t, r) {
        ...
        return (
          "string" == typeof e
            ? (function (e) {
                ...
                var r = (getComputedStyle(t).color || "rgb(0, 0, 0)").match(
                    /[+-]?\d+(\.\d+)?/g
                  ),
                  o = r
                    ? r.map(function (e) {
                ...
                if (
                  ...
                  o.length = 3;
                else if (o.length < 3) return [0, 0, 0];
                return o;
            ...
            : Array.isArray(e) &&
              3 === e.length &&
              e.slice(0, 3).forEach(function (e, r) {
                t[r] = e / 255;
              }),
          t
        );
      ...
      var a = (function () {
        function e(e) {
          ...
          (this.isRunning = !1),
            ...
            (this.render = function (e) {
              var r = t.gl,
                o = t.program,
                n = t.buffer,
                l = (e - t.lastTime) * t.speed * 0.001;
              (t.accumTime += l),
                (t.lastTime = e),
                i.resizeCanvasToDisplaySize(r.canvas),
                r.viewport(0, 0, r.canvas.width, r.canvas.height),
                r.useProgram(o.handle),
              ...
              r.enableVertexAttribArray(a),
                ...
                r.uniform2f(
                  o.uniforms.resolution,
                  r.canvas.width,
                  r.canvas.height
                ),
                r.uniform1f(o.uniforms.layerCount, t.layerCount),
                r.uniform1f(o.uniforms.time, t.accumTime),
                r.uniform3fv(o.uniforms.bgColor, t.bgColor),
                r.uniform3fv(o.uniforms.cloudColor1, t.cloudColor1),
                r.uniform3fv(o.uniforms.cloudColor2, t.cloudColor2),
                r.drawArrays(r.TRIANGLES, 0, 6),
                t.isRunning && requestAnimationFrame(t.render);
            });
          ...
          var o = e.speed || 1,
            n = e.layerCount || 5,
            l = e.cloudColor1 || [25, 178, 204],
            a = e.cloudColor2 || [255, 255, 255],
          ...
          (r.style.width = "100%"),
            ...
            this.setBgColor(u),
            this.setCloudColor1(l),
            this.setCloudColor2(a),
            this.start();
        }
        return (
          (e.prototype.queryRootElement = function (e) {
            if ("string" == typeof e) {
              ...
              return t
                ? t instanceof HTMLCanvasElement
                  ? t
                  : (console.error(
                      "options.selector element is not a <canvas> element"
                    ),
                    null)
                : (console.error("options.selector element not found"), null);
            }
            return e instanceof HTMLElement
              ? e instanceof HTMLCanvasElement
                ...
                : (console.error(
                  ...
                  null)
              : (console.error("options.selector value is invalid"), null);
          }),
          (e.prototype.initGraphics = function (e) {
            var t = i.createContext(e);
            if (!t) throw new Error("Failed to create WebGL context");
            ...
            if (!l)
              throw (
                (t.deleteProgram(r), new Error("Failed to create WebGL buffer"))
              );
          ...
          (e.prototype.start = function () {
            this.isRunning ||
              ((this.isRunning = !0), requestAnimationFrame(this.render));
          }),
          ...
          (e.prototype.setCloudColor1 = function (e) {
            var t = l(e);
            t && (this.cloudColor1 = t);
          }),
          (e.prototype.setCloudColor2 = function (e) {
            var t = l(e);
            t && (this.cloudColor2 = t);
          }),
      ...
      (t.Klouds = a),
        ...
        window &&
          ...
          (window.jQuery.fn.Klouds = function (e) {
            e = e || {};
            for (var t = this.get(), r = [], o = 0; o < t.length; ++o)
              (e.selector = t[o]), r.push(new a(e));
            return r;
          });
    },
    function (e, t, r) {
        ...
        return n
          ? (e.shaderSource(n, r),
            ...
            e.getShaderParameter(n, e.COMPILE_STATUS)
              ? n
              : (console.debug(e.getShaderInfoLog(n)),
                console.error("Failed to compile WebGL shader"),
                e.deleteShader(n),
                null))
          : (console.error("Failed to create WebGL shader"), null);
      }
      (t.__esModule = !0),
        ...
        (function (e) {
          (e[(e.VERTEX = 0)] = "VERTEX"), (e[(e.FRAGMENT = 1)] = "FRAGMENT");
        })((o = t.ShaderType || (t.ShaderType = {}))),
        (t.createShader = n),
        (t.createProgram = function (e, t, r, i, l) {
          var a = e.createProgram();
          if (!a) return console.error("Failed to create WebGL program"), null;
          var u = n(e, o.VERTEX, t),
            s = n(e, o.FRAGMENT, r);
          if (!u || !s)
            return (
              console.error(
                "Failed to create a shader while creating a program"
              ),
              null
            );
          if (
            ...
            return (
              ...
              console.debug(e.getProgramInfoLog(a)),
              null
            );
          if (!e.getProgramParameter(a, e.VALIDATE_STATUS))
            return (
              e.deleteProgram(a),
              e.deleteShader(u),
              e.deleteShader(s),
          ...
          for (var c = {}, f = 0; f < i.length; ++f) {
            var d = i[f],
              p = e.getAttribLocation(a, d);
            if (-1 === p)
              return (
                console.error(
                  'Program attribute named "' + d + "\" doesn't exist"
                ),
                e.deleteProgram(a),
                null
              );
          ...
          for (f = 0; f < l.length; ++f) {
            var h = l[f],
              g = e.getUniformLocation(a, h);
            if (null === g)
              return (
                console.error(
                  'Program uniform named "' + h + "\" doesn't exist"
                ),
                e.deleteProgram(a),
                null
              );
          ...
          return { handle: a, attributes: c, uniforms: m };
        }),
        (t.resizeCanvasToDisplaySize = function (e) {
          var t = e.clientWidth,
            r = e.clientHeight;
          return (
            (e.width !== t || e.height !== r) &&
            ((e.width = t), (e.height = r), !0)
          );
        });
    },
  ]);
