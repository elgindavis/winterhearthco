        ...
        <div className="row">
          <div className="col-lg-5 col-md-6 col-sm-6">
            <div className="single-footer-widget text-white">
              ...
              <p>Change the heart, change the world.</p>
            ...
            <div style={{ padding: "40px 0" }}>
              <button
                ...
                onClick={() => {
                  console.log("Need to add cookie prefs functionality");
                }}
              >
              ...
              >
                <div id="mc_embed_signup_scroll">
                  <div className="mc-field-group">
                    <label className="form-label" htmlFor="mce-FNAME">
                      First Name{" "}
                      <span
                        className="asterisk"
                    ...
                    <input
                      className="input-fields required"
                      type="text"
                      defaultValue=""
                      name="FNAME"
                      id="mce-FNAME"
                  ...
                  <div className="mc-field-group ">
                    <label className="form-label" htmlFor="mce-EMAIL">
                      Email Address <span className="asterisk"></span>
                    </label>
                    <input
                      className="input-fields required email"
                      type="email"
                      defaultValue=""
                      name="EMAIL"
                      id="mce-EMAIL"
                  ...
                  <div id="mce-responses" className="clear">
                    ...
                    >
                      <input
                        type="text"
                        name="b_82935dc1a750f772912d12316_31c5d4e468"
                        tabIndex="-1"
                        defaultValue=""
                      />
                    </div>
